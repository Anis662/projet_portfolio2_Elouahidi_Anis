...
<section id="portfolio" class="portfolio section-bg">
    <div class="container" data-aos="fade-up">
      ...
      @if ($i->categorie === 3)
      <div class="col-lg-4 col-md-6 portfolio-item filter-web {{ $i->categorie }}">
        <div class="portfolio-wrap">
          <img src="{{ asset("img/$i->img") }}" class="img-fluid" alt="">
          <div class="portfolio-info">
            <h4>Web 3</h4>
            <p>Web</p>
            <div class="portfolio-links">
      ...
      @endif
      @if ($i->categorie === 2)
      <div class="col-lg-4 col-md-6 portfolio-item filter-card {{ $i->categorie }}">
        <div class="portfolio-wrap">
          <img src="{{ asset("img/$i->img") }}" class="img-fluid" alt="">
          <div class="portfolio-info">
            <h4>Web 3</h4>
      ...
      @if ($i->categorie === 1)
      <div class="col-lg-4 col-md-6 portfolio-item filter-app {{ $i->categorie }}">
        <div class="portfolio-wrap">
          <img src="{{ asset("img/$i->img") }}" class="img-fluid" alt="">
          <div class="portfolio-info">
            <h4>Web 3</h4>
